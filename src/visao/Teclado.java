...
public class Teclado extends JPanel implements ActionListener{
	...
	private final Color COR_AZUL = new Color(5,79,119);
	...
	public Teclado() {
		...
		c.weightx = 1; //Corrige Espaçamento eixo X
		c.weighty = 1; //Corrige Espaçamento eixo Y
		c.fill = GridBagConstraints.BOTH; // Corrige Bordas
